...
//ADDED
		...
		if(db_fetch($add_cust_info_exists)) 
			{
		        update_customer_additional_info($_POST['customer_id'], $_POST['cust_city'], $_POST['cust_department'],
			$_POST['cust_country'], $_POST['cust_postcode'], $_POST['cust_doc_type'], $_POST['cust_valid_digit'], $_POST['cust_start_date'],
			$_POST['cust_sector'], $_POST['cust_class'], $_POST['cust_custom_one'], $_POST['cust_custom_two'], $_POST['cust_custom_three'], $_POST['cust_custom_four']);
		    } 
		    else 
		    {
		        add_customer_additional_info($_POST['customer_id'], $_POST['cust_city'], $_POST['cust_department'],
			$_POST['cust_country'], $_POST['cust_postcode'], $_POST['cust_doc_type'], $_POST['cust_valid_digit'], $_POST['cust_start_date'],
			$_POST['cust_sector'], $_POST['cust_class'], $_POST['cust_custom_one'], $_POST['cust_custom_two'], $_POST['cust_custom_three'], $_POST['cust_custom_four']);
		    }
...
//ADDED
			$_POST['customer_id'] = '';
			$_POST['cust_city']  = '';
			$_POST['cust_department']  = '';
			$_POST['cust_country']  = '';
			$_POST['cust_postcode']  = '';
			$_POST['cust_doc_type']  = -1;
			$_POST['cust_valid_digit']  = '';
			$_POST['cust_start_date']  = '';
			$_POST['cust_sector']  = '';
			$_POST['cust_class']  = -1;
			$_POST['cust_custom_one']  = '';
			$_POST['cust_custom_two']  = '';
			$_POST['cust_custom_three']  = '';
...
//ADDED
		$sales_type_name = $myrow["sales_type"];
		$is_active = $myrow["inactive"];
		$credit_status_name  = $myrow["credit_status"];
		$payment_terms_name  = $myrow["payment_terms"];
...
//ADDED
	...
	text_row(_("Postcode:"), 'cust_postcode', null, 30, 30);
//END ADDED
	text_row(_("GSTNo:"), 'tax_id', null, 40, 40);
//ADDED
	text_row(_("Validation Digit:"), 'cust_valid_digit', null, 40, 1);
...
// ADDED
	date_row(_("Customer Since") . ":", 'cust_start_date', '', false);
//END ADDED
	if($selected_id)
