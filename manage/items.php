...
//ADDED
				...
				if(db_fetch($add_item_info_exists)) 
					{
						update_item_additional_info($_POST['stock_id'], $_POST['item_bin_num'], $_POST['item_prime_supp'],
					$_POST['item_prime_supp_no'], $_POST['item_alternative_part_no'], $_POST['item_manu_part_no'], 
					$_POST['item_start_date'], $_POST['item_custom_one'], $_POST['item_custom_two'], $_POST['item_custom_three'], 
					$_POST['item_custom_four']);
					} 
					else 
					{
						add_item_additional_info($_POST['NewStockID'], $_POST['item_bin_num'], $_POST['item_prime_supp'],
					$_POST['item_prime_supp_no'], $_POST['item_alternative_part_no'], $_POST['item_manu_part_no'], 
					$_POST['item_start_date'], $_POST['item_custom_one'], $_POST['item_custom_two'], $_POST['item_custom_three'], 
					$_POST['item_custom_four']);
					}
...
//END ADDED
		...
		{ //it is a NEW part
			...
			add_item($_POST['NewStockID'], $_POST['description'],
				...
				get_post('fa_class_id'));
// ADDED
			add_item_additional_info($_POST['stock_id'], $_POST['item_bin_num'], $_POST['item_prime_supp'],
					$_POST['item_prime_supp_no'], $_POST['item_alternative_part_no'], $_POST['item_manu_part_no'], 
					$_POST['item_start_date'], $_POST['item_custom_one'], $_POST['item_custom_two'], $_POST['item_custom_three'], 
					$_POST['item_custom_four']);
//END ADDED
...
function item_settings(&$stock_id, $new_item) 
{
	...
	{ // Must be modifying an existing item
		if (get_post('NewStockID') != get_post('stock_id') || get_post('addupdate')) { // first item display
			...
			$category_name = $myrow["category_id"];
			$item_tax_types_name = $myrow["tax_type_id"];
			// $sales_accname =  $myrow['sales_account'];
...
// ADDED
	text_row(_("Bin number:"), 'item_bin_num', null, 52, 200);
	supplier_list_row(_("Primary supplier:"), 'item_prime_supp', null, false, true, false, true);
	text_row(_("Primary suppliers Part number:"), 'item_prime_supp_no', null, 52, 200);
	text_row(_("Alternative part number:"), 'item_alternative_part_no', null, 52, 200);
	text_row(_("Manufacturers part number:"), 'item_manu_part_no', null, 52, 200);
//END ADDED
