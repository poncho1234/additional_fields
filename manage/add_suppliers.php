...
//ADDED
		$_POST['supplier_id'] = '';
		$_POST['supp_city']  = '';
		$_POST['supp_department']  = '';
		$_POST['supp_country']  = '';
		$_POST['supp_postcode']  = '';
		$_POST['supp_doc_type']  = -1;
		$_POST['supp_valid_digit']  = '';
		$_POST['supp_start_date']  = '';
		$_POST['supp_sector']  = '';
		$_POST['supp_class']  = -1;
		$_POST['supp_custom_one']  = '';
		$_POST['supp_custom_two']  = '';
		$_POST['supp_custom_three']  = '';
...
//ADDED
				...
				if(db_fetch($add_supp_info_exists)) 
					{
				        update_supplier_additional_info($_POST['supplier_id'], $_POST['supp_city'], $_POST['supp_department'],
					$_POST['supp_country'], $_POST['supp_postcode'], $_POST['supp_doc_type'], $_POST['supp_valid_digit'], $_POST['supp_start_date'],
					$_POST['supp_sector'], $_POST['supp_class'], $_POST['supp_custom_one'], $_POST['supp_custom_two'], $_POST['supp_custom_three'], $_POST['supp_custom_four']);
				    } 
				    else 
				    {
				        add_supplier_additional_info($_POST['supplier_id'], $_POST['supp_city'], $_POST['supp_department'],
					$_POST['supp_country'], $_POST['supp_postcode'], $_POST['supp_doc_type'], $_POST['supp_valid_digit'], $_POST['supp_start_date'],
					$_POST['supp_sector'], $_POST['supp_class'], $_POST['supp_custom_one'], $_POST['supp_custom_two'], $_POST['supp_custom_three'], $_POST['supp_custom_four']);
				    }
