...
function customer_settings($selected_id) 
{
	...
	city_list_row(_("City:"), 'cust_city', null, true, _("Select City"));
	departments_list_row(_("State/Department:"), 'cust_department', null, true, _("Select Department"));
	country_list_row(_("Country:"), 'cust_country', null, true, _("Select Country"));
	...
	document_types_list_row(_("Type of Document:"), 'cust_doc_type', null, true, _("Select Document Type"));
	customer_class_list_row(_("Customer Class:"), 'cust_class', null, true, _("Select Class"));
	...
	sectors_list_row(_("Sector:"), 'cust_sector', null, true, _("Select Sector"));
